...
public interface RocketMQConstants {
    // rocketmq的服务类型
    ServiceType ROCKETMQ_CLIENT = ServiceTypeFactory.of(8321, "ROCKETMQ_CLIENT", QUEUE, RECORD_STATISTICS);

    AnnotationKey ROCKETMQ_BROKER_URL = AnnotationKeyFactory.of(401, "rocketmq.broker.address", AnnotationKeyProperty.VIEW_IN_RECORD_SET);

    ServiceType ROCKETMQ_CLIENT_INTERNAL = ServiceTypeFactory.of(9902, "ROCKETMQ_CLIENT_INTERNAL", "ROCKET_MQ_CLIENT");

    AnnotationKey ROCKETMQ_MESSAGE = AnnotationKeyFactory.of(402, "rocketmq.message", AnnotationKeyProperty.VIEW_IN_RECORD_SET);
    // rocketmq基础包
