 ...
 * @author jaehong.kim
 */
public class RedissonClientConstructorInterceptor implements AroundInterceptor {

    private final PLogger logger = PLoggerFactory.getLogger(this.getClass());
    private final boolean isDebug = logger.isDebugEnabled();

    public RedissonClientConstructorInterceptor(TraceContext traceContext, MethodDescriptor methodDescriptor) {
    }
    ...
    public void before(Object target, Object[] args) {
        ...
        try {
            ...
            // fifth argument is host
            String endpoint = args[4] + ":" + args[5];
